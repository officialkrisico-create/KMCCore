...
/** /kmcstats [player] — shows full extended stats */
public class StatsCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        sender.sendMessage(MessageUtil.color("&6── Huidig seizoen ──"));
        sender.sendMessage(MessageUtil.color("&7Punten:        &e" + pd.getPoints()));
        sender.sendMessage(MessageUtil.color("&7Munten:        &6" + pd.getCoins()));
        ...
        sender.sendMessage(MessageUtil.color("&7Totaal verdiend: &6" + pd.getTotalCoinsEarned() + " munten"));
